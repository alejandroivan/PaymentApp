...
class VoucherRouter: NSObject, VoucherRoutingLogic, VoucherDataPassing {
    ...
    //func navigateToSomewhere(source: VoucherViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: VoucherDataStore, destination: inout SomewhereDataStore)
    //{
